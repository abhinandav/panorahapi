...
const Details = ({ activeStep, isLastStep, handleNext, handlePrev }) => {
  // States
  const [value, setValue] = useState('doctypelist')
  ...
  return (
    <div className='flex flex-col gap-6'>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div onClick={() => setValue('doctypelist')} className='flex items-center justify-between cursor-pointer gap-4'>
          ...
          <Radio value='doctypelist' onChange={handleChange} checked={value === 'doctypelist'} />
        </div>
