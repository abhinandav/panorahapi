    ...
    >
      ...
      >
        <SubMenu label={dictionary['navigation'].dashboards} icon={<i className='tabler-smart-home' />}>
          <MenuItem href={`/${locale}/dashboards/doctypelist`} icon={<i className='tabler-chart-pie-2' />}>
            {dictionary['navigation'].doctypelist}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboards/insertdata`} icon={<i className='tabler-trending-up' />}>
            {dictionary['navigation'].analytics}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboards/deletedoc`} icon={<i className='tabler-shopping-cart' />}>
            {dictionary['navigation'].eCommerce}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboards/updatedoc`} icon={<i className='tabler-school' />}>
            {dictionary['navigation'].academy}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboards/fetchdatas`} icon={<i className='tabler-truck' />}>
